...
val ErrorCodes =
    listOf(
            ...
            Rejection(
                ...
                helpText =
                    "Your London Underground ticket, or ticket with London Underground validity, cannot be used to travel on National Rail services at this location.",
                action = ActionByStaff.TO_TICKET_OFFICE,
            ),
            Rejection(
                "123",
            ...
            Rejection(
                ...
                helpText =
                    "This station isn't a permitted destination for your ticket. If you're breaking your journey, you might inadvertently see this error.",
                action = ActionByStaff.CHECK_VALIDITY_THEN_TO,
            ),
            Rejection(
                "126",
                ...
                helpText =
                    "This station isn't a permitted origin for your ticket. If you're breaking your journey, you might inadvertently see this error.",
                action = ActionByStaff.CHECK_VALIDITY_THEN_TO,
            ),
            Rejection(
                "127",
                ...
                helpText =
                    "The validity period of your ticket doesn't include today's date. If a validity easement is in place due to industrial action or a 'Do Not Travel' warning, this won't be followed by ticket barriers.",
                action = ActionByStaff.CHECK_VALIDITY_THEN_TO,
            ),
            Rejection(
                "128",
            ...
            Rejection(
                ...
                laymansReason =
                    "Some train operators set their gatelines to reject all tickets of a certain type or with a particular discount. This is common to impose \"Railcard blocks\" for manual verification of your discount.",
                helpText =
                    "The gateline has been told to reject your ticket despite it likely being valid in order to perform a manual check.",
                action = ActionByStaff.SEEK_ASSISTANCE,
            ),
            Rejection(
                "136",
